...
#     if randomPlayer == 1:
#         games.append(game.Game(width, height, token, agent.RandomAgent("random"), aba.AlphaBetaAgent("alphabeta", 3)))
#     else:
...
games.append(game.Game(10, 8, 4, aba.AlphaBetaAgent("alphabeta", 3), agent.RandomAgent("random")))
games.append(game.Game(10, 8, 5, aba.AlphaBetaAgent("alphabeta", 3), agent.RandomAgent("random")))
# Execute the game
wins = 0
ties = 0
for game in games:
